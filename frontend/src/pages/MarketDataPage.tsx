...
function CandlestickChart({ symbol, interval, liveBar }: CandlestickChartProps) {
...
export function MarketDataPage({ quotes, orderBooks, lastOhlcv }: MarketDataPageProps) {
  ...
  const book: OrderBook | null = orderBooks.get(symbol) ?? null;
